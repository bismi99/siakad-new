                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-3">
                            <div class="breadcomb-report">
                                <a href="{{ route('tahunakademik.create') }}" data-toggle="tooltip" data-placement="left" title="Tambah Data" class="btn"><i class="notika-icon notika-up-arrow"> Tambah Data</i></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-sc-ex">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="button">
                                            <a href="{{ route('tahunakademik.edit', $item->id) }}"
                                                class="btn btn-warning btn-notika-warning waves-effect" data-toggle="tooltip" data-placement="left" title="Edit Data">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <a
                                                onclick="return confirm('Yakin untuk menghapus tahun akademik {{$item->title}}? ')">
                                                    <form action="{{ route('tahunakademik.destroy', $item->id) }}"
