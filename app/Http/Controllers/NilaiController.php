...
class NilaiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // dd($nilai);
        return view('pages.siswa.nilai.index',compact('nilai','ta'));
    }
    ...
    {
        $items = Nilai::where('jadwal_id', $id)->get();
        $jadwal = Jadwal::findOrFail($id);
        $ta = TahunAkademik::where('status', 'Aktif')->first();

        return view('pages.guru.nilai.show',compact('items','jadwal','ta','id'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.guru.nilai.edit')->with([
            'items' => $items,
            'jadwal' => $jadwal,
            'id' => $id,
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        foreach($data['idMhs'] as $index=>$item){
            ...
            Nilai::where('user_id', $data['idMhs'][$index])
            ->where('jadwal_id', $id)
            ->update([
    ...
    public function list(Request $request)
    {
       ...
       $data = Jadwal::where('user_id', Auth::user()->id)->where('tahunakademik_id', $ta->id)->with('mapel')->get();
        ...
        return view('pages.guru.nilai.list')->with([
            'data' => $data,
        ]);
    }
