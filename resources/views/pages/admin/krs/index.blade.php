                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-3">
                            <div class="breadcomb-report">
                                <a href="{{ route('krs.create') }}" data-toggle="tooltip" data-placement="left"
                        ...
                        <table class="table table-sc-ex">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->jadwal->user->name }} - {{ $item->jadwal->mapel->mapel }} -
                                        {{ $item->jadwal->kelas->kelas }}</td>
                                    ...
                                    <td>
                                        <div class="button">
                                            ...
                                            <a onclick="return confirm('Yakin untuk menghapus krs {{$item->title}}? ')">
